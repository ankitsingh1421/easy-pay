# Pay Now
![](https://github.com/ankitsingh1421/easy-pay/blob/main/images/default.jpg)
...
### Clone Repository
```bash
git clone https://github.com/ankitsingh1421/easy-pay.git
cd easy-pay
...
Happy coding & may your payments always be seamless! ⚡💻